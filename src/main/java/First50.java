...
public class First50
{
    ...
    public void Problem13 ()
    {
        ...
        long firstTen = 0, secondTen = 0, thirdTen = 0, fourthTen = 0, fifthTen = 0;

        for ( String digit : digits )
        {
            firstTen += Long.parseLong ( digit.substring ( 0, 10 ));
            secondTen += Long.parseLong ( digit.substring ( 10, 20 ));
            thirdTen += Long.parseLong ( digit.substring ( 20, 30 ));
            fourthTen += Long.parseLong ( digit.substring ( 30, 40 ));
            fifthTen += Long.parseLong ( digit.substring ( 40 ));
        }

        String stringFirst = String.valueOf ( firstTen );
        String stringSecond = String.valueOf ( secondTen );
        String stringThird = String.valueOf ( thirdTen );
        String stringFourth = String.valueOf ( fourthTen );
        String stringFifth = String.valueOf ( fifthTen );

        if ( stringFifth.length () > 10 )
        {
            String carryOver = stringFifth.substring ( 0, stringFifth.length () - 10 );
            long carryOverDigits = Long.parseLong ( carryOver );
            fourthTen += carryOverDigits;
            // stringFifth = stringFifth.substring ( carryOver.length ()); - Add this into the following to get the full result
            stringFourth = String.valueOf ( fourthTen );
        }
        if ( stringFourth.length () > 10 )
        {
            String carryOver = stringFourth.substring ( 0, stringFourth.length () - 10 );
            long carryOverDigits = Long.parseLong ( carryOver );
            thirdTen += carryOverDigits;
            stringThird = String.valueOf ( thirdTen );
        }
        if ( stringThird.length () > 10 )
        {
            String carryOver = stringThird.substring ( 0, stringThird.length () - 10 );
            long carryOverDigits = Long.parseLong ( carryOver );
            secondTen += carryOverDigits;
            stringSecond = String.valueOf ( secondTen );
        }
        if ( stringSecond.length () > 10 )
        {
            String carryOver = stringSecond.substring ( 0, stringSecond.length () - 10 );
            long carryOverDigits = Long.parseLong ( carryOver );
            firstTen += carryOverDigits;
            stringFirst = String.valueOf ( firstTen );
        }
        if ( stringFirst.length () > 10 )
        {
            String carryOver = stringFirst.substring ( 0, stringFirst.length () - 10 );
            long carryOverDigits = Long.parseLong ( carryOver );
            firstTen += carryOverDigits;
            stringFirst = String.valueOf ( firstTen );
        }
